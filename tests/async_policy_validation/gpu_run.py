...
def reload_checkpoint(model_path: str, output: Path, prompt, sampling, *, full_parameters: bool = False) -> dict:
    import torch
...
def run_case(model_path: str, output: Path, *, mode: str, fault: str | None = None,
             full_parameters: bool = False, compiled: bool = False, graphs: bool = False) -> dict:
    import torch
